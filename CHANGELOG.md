...
- Remendra accepts existing Remendra v2 JSONL exports during migration.
- Remendra removes stale Remendra v2 context/output packets before inserting its own packet.
