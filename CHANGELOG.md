...
- Remendra accepts existing Blackhole v2 JSONL exports during migration.
- Remendra removes stale Blackhole v2 context/output packets before inserting its own packet.
- The original MIT-licensed project history and legacy engine remain attributed and available for explicit rollback.
